...
$(document).ready(function () {
  var collectedFromCal = $("#collected-from");
  var collectedToCal = $("#collected-to");
  var donatedOnCal = $("#donated-on");
  ...
  donatedOnCal.on("change", function (e) {
    date = new Date(e.target.value);
    var toYear = document.getElementById("donated-year");
    var toMonth = document.getElementById("donated-month");
    var toDay = document.getElementById("donated-day");
...
//# sourceMappingURL=/calendars.71e94341.map