...
var nextPage = function nextPage() {
  var nextLink = document.getElementById("next").href;
 ...
 */
var validateAndRegisterUser = function validateAndRegisterUser() {
  (0, _errors.cleanErrors)("Error", "name");
  sessionStorage.removeItem("longFormNoUserError");
  var nameValue = document.querySelector("#name").value;
  if ((0, _helpers.validateName)(nameValue)) {
    addUser(nameValue);
    nextPage();
  } else {
    (0, _errors.showError)("name", _errors2.default.introIvalidUsername);
  }
};
var registerButton = document.querySelector("#registerUser");
...
var longFormError = sessionStorage.getItem("longFormNoUserError");
if (longFormError) {
  (0, _errors.showError)("name", longFormError);
}
},{"./errors":6,"./helpers":7}],80:[function(require,module,exports) {
...
//# sourceMappingURL=/register_user.9e238954.map